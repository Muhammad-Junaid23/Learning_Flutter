...
class GetAllRemainingCities extends StatelessWidget {
  const GetAllRemainingCities({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Text("Get All Remaining Cities"),
      ...
      body: StreamProvider.value(
        value: CityService().getAllRemainingCities(),
